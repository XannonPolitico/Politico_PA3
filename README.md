...
* `import pandas as pd` - Gives as access to the Pandas Library.
* `pd.read_csv('cars.csv')` - Let's us read and access a `.csv` file uploaded into our Jupyter Notebook.
...
To view the main python program for Programming Assignment 2, click this link https://github.com/XannonPolitico/Politico_PA3/blob/main/Politico_PA3.ipynb and download. Open in Jupyter Notebook, then run all cells.
